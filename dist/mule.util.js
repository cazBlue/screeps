...
const getExtension = (creep) => {
    ...
    extensions.sort((a, b) => {
        ...
        if (a.structureType === STRUCTURE_TOWER &&
            a.store.getUsedCapacity(RESOURCE_ENERGY) > a.store.getCapacity(RESOURCE_ENERGY) * .6) {
            return 1;
        }
        if (b.structureType === STRUCTURE_TOWER &&
            b.store.getUsedCapacity(RESOURCE_ENERGY) > b.store.getCapacity(RESOURCE_ENERGY) * .6) {
            return -1;
        }
